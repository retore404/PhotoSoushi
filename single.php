			...
			<section id="content">
				...
				if ( have_posts() ) :
					...
					<article class="grid-container-article">
						...
						<section id="share">
							<span>Share.</span><br>
							<a href="https://twitter.com/share?url=<?php the_permalink(); ?>&text=<?php echo rawurlencode( get_the_title() . ' | ' . get_bloginfo( 'name' ) . "\n" ); ?>" target="_blank"><span class="share-icon ps-sns-icon-twitter"></span></a>
							<a href="http://b.hatena.ne.jp/entry/<?php the_permalink(); ?>" target="_blank"><span class="share-icon ps-sns-icon-hatenabookmark"></span></a>
							<a href="https://social-plugins.line.me/lineit/share?url=<?php the_permalink(); ?>" ><span class="share-icon ps-sns-icon-line"></span></a>
							<a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" ><span class="share-icon ps-sns-icon-facebook"></span></a>
							<a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>" ><span class="share-icon ps-sns-icon-pinterest"></span></a>
						</section>
						<section id="comments">
							<?php
								comments_template();
