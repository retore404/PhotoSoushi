				...
				if ( have_posts() ) :
					...
					<article class="grid-container-article">
						...
						<section id="share">
							...
							<a href="https://social-plugins.line.me/lineit/share?url=<?php the_permalink(); ?>" class="share-icon"><span class="ps-sns-icon-line"></span></a>
							<a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" class="share-icon"><span class="ps-sns-icon-facebook"></span></a>
							<a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>" class="share-icon"><span class="ps-sns-icon-pinterest"></span></a>
						</section>
						<section id="comments">
							<?php
								comments_template();
